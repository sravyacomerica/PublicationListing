...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="org.demo.test.PublicationSearchServlet"
...
<title>Publication Search Page</title>
<style type="text/css">
.table-fill {
	background: white;
	border-radius: 3px;
...
<body>
	...
	<form form="searchform" action="PublicationSearchServlet"
		onsubmit="return validate()" name="searchform" method="Post">
		...
		<%
			if (request.getAttribute("Values1") != null) {

				@SuppressWarnings("unchecked")
				List<PublicationDetails> values = (List<PublicationDetails>) request.getAttribute("Values1");
		%>
		<table class="table-fill">
			<thead>
				<tr>
					...
					<th class="text-left">Newspaper</th>
					<th class="text-left">Pages</th>
				</tr>
			</thead>

			<%
				for (PublicationDetails element : values) {
			%>
			<tbody class="table-hover">
				<tr>
					...
					<td class="text-left">
						<%
							out.println(element.getAuthor());
						%>
					</td>
					<td class="text-left">
						<%
							out.println(element.getYear());
						%>
					</td>
					<td class="text-left">
						<%
							out.println(element.getNewspaper());
						%>
					</td>
					<td class="text-left">
						<%
							out.println(element.getPages());
								}
							}
						%>
					</td>
